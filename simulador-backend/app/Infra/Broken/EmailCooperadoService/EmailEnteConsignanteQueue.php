...
namespace App\Infra\Broken\EmailCooperadoService;
...
class EmailEnteConsignanteQueue implements Queue
{
    ...
    protected $queue_consumer = 'notificaEnteConsignante';
    protected $routingKey_consumer = 'simular.consignado.*';
    ...
    public function publish($message)
    {
        ...
        $this->channel->basic_publish($msg, $this->exchange_consumer, $this->routingKey_consumer);
    }
