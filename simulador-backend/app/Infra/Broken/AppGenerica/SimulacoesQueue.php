...
namespace App\Infra\Broken\AppGenerica;
...
class SimulacoesQueue implements Queue
{
    protected $connection;
    protected $channel;
    protected $exchange_consumer = 'credito';
    protected $queue_consumer = 'simulacoes';
    protected $routingKey_consumer = 'simulacao.#';
